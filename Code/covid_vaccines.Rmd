...
pacman::p_load(tidyverse, magrittr, janitor, lubridate, skimr, # data analysis packages
               DT, pander, stargazer, knitr, # for nicely printed outputs
               scales, DataExplorer, # for plots
...
We extracted the data on `June 24, 2021 at approximately 9:00 AM EDT` using the code chunk below.
...
animatedMap = tm_shape(cty_sf_vac, bbox = bbox_new) +
  ...
  tm_credits("Data Source: The CDC's COVID-19 Vaccinations in the US by County Dataset \t")

tmap_animation(animatedMap, filename = "../Figures/animatedVaccineMap.gif", fps = 2.5,
               width = 1000, height = 700, outer.margins = 0.03)
```
